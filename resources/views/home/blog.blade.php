                                ...
                                <div class="entry__meta">
                                    ...
                                    <div class="entry__meta-cat">
                                        ...
                                        <span class="cat-links">
                                            <a href="{{  url('/category', $category->id) }}">{{ $post->category }}</a>                                         
                                        </span>
                                    </div>
                                </div>
                            </header>
                            ...
                            <div class="entry__media">
                                <figure class="featured-image">
                                    <img src="/post/{{ $post->image }}" 
                                         srcset="/post/{{ $post->image }} 2400w, 
                                                 /post/{{ $post->image }} 1200w, 
                                                /post/{{ $post->image }} 600w" sizes="(max-width: 2400px) 100vw, 2400px" alt="">
                                </figure>
                            </div>
