          ...
          <h2 class="font_size">All Posts</h2>
            <table class="center">
              ...
              <tr>
                ...
                <td><?php echo e($post->small_description); ?></td>
                <td><?php echo e($post->description); ?></td>
                <td><?php echo e($post->category); ?></td>
                <td>
                  <img class="img_size" src="/post/<?php echo e($post->image); ?>" alt="">
                </td>
                <td>
                  <a class="btn btn-danger" onclick="return confirm('Are you sure you want to delete this?')" href="<?php echo e(url('delete_post',$post->id)); ?>">Delete</a>
                </td>
                <td>
                  <a class="btn btn-success" href="<?php echo e(url('update_post', $post->id)); ?>">Edit</a>
                </td>
              </tr>
...
</html><?php /**PATH C:\Users\USER\OneDrive\Desktop\blog-app\resources\views/admin/show_post.blade.php ENDPATH**/ ?>